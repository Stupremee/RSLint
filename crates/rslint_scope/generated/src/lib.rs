...
impl TryFrom<RelId> for Relations {
    ...
    fn try_from(rid: RelId) -> ::std::result::Result<Self, ()> {
        ...
        56 => Ok(Relations::outputs_no_shadow_NoShadow),
        57 => Ok(Relations::outputs_no_undef_ChainedWith),
        58 => Ok(Relations::outputs_no_undef_NoUndef),
        59 => Ok(Relations::outputs_typeof_undef_TypeofUndef),
        60 => Ok(Relations::outputs_typeof_undef_WithinTypeofExpr),
        61 => Ok(Relations::outputs_unused_vars_UnusedVariables),
        62 => Ok(Relations::outputs_unused_vars_VariableUsages),
        63 => Ok(Relations::outputs_use_before_def_UseBeforeDef),
        64 => Ok(Relations::scopes_ChildScope),
        65 => Ok(Relations::scopes_FunctionLevelScope),
        66 => Ok(Relations::scopes_ScopeOfId),
             _  => Err(())
         }
    }
}
pub fn relid2name(rid: RelId) -> Option<&'static str> {
   match rid {
        ...
        56 => Some(&"outputs::no_shadow::NoShadow"),
        57 => Some(&"outputs::no_undef::ChainedWith"),
        58 => Some(&"outputs::no_undef::NoUndef"),
        59 => Some(&"outputs::typeof_undef::TypeofUndef"),
        60 => Some(&"outputs::typeof_undef::WithinTypeofExpr"),
        61 => Some(&"outputs::unused_vars::UnusedVariables"),
        62 => Some(&"outputs::unused_vars::VariableUsages"),
        63 => Some(&"outputs::use_before_def::UseBeforeDef"),
        64 => Some(&"scopes::ChildScope"),
        65 => Some(&"scopes::FunctionLevelScope"),
        66 => Some(&"scopes::ScopeOfId"),
       _  => None
   }
}
#[cfg(feature = "c_api")]
...
pub static RELIDMAP: ::once_cell::sync::Lazy<::fnv::FnvHashMap<Relations, &'static str>> =
    ::once_cell::sync::Lazy::new(|| {
        let mut map = ::fnv::FnvHashMap::with_capacity_and_hasher(67, ::fnv::FnvBuildHasher::default());
...
pub static RELIDMAPC: ::once_cell::sync::Lazy<::fnv::FnvHashMap<RelId, &'static ::std::ffi::CStr>> =
    ::once_cell::sync::Lazy::new(|| {
        ...
        map.insert(56, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::no_shadow::NoShadow\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(57, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::no_undef::ChainedWith\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(58, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::no_undef::NoUndef\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(59, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::typeof_undef::TypeofUndef\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(60, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::typeof_undef::WithinTypeofExpr\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(61, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::unused_vars::UnusedVariables\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(62, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::unused_vars::VariableUsages\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(63, ::std::ffi::CStr::from_bytes_with_nul(b"outputs::use_before_def::UseBeforeDef\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(64, ::std::ffi::CStr::from_bytes_with_nul(b"scopes::ChildScope\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(65, ::std::ffi::CStr::from_bytes_with_nul(b"scopes::FunctionLevelScope\0").expect("Unreachable: A null byte was specifically inserted"));
        map.insert(66, ::std::ffi::CStr::from_bytes_with_nul(b"scopes::ScopeOfId\0").expect("Unreachable: A null byte was specifically inserted"));
        map
    });
...
pub fn indexes2arrid(idx: Indexes) -> ArrId {
    match idx {
        ...
        Indexes::name_in_scope_Index_VariableInScope => ( 55, 11),
        Indexes::name_in_scope_Index_VariablesForScope => ( 55, 12),
        Indexes::scopes_ChildScopeByParent => ( 64, 2),
    }
}
...
pub enum Relations {
    ...
    outputs_no_shadow_NoShadow = 56,
    outputs_no_undef_ChainedWith = 57,
    outputs_no_undef_NoUndef = 58,
    outputs_typeof_undef_TypeofUndef = 59,
    outputs_typeof_undef_WithinTypeofExpr = 60,
    outputs_unused_vars_UnusedVariables = 61,
    outputs_unused_vars_VariableUsages = 62,
    outputs_use_before_def_UseBeforeDef = 63,
    scopes_ChildScope = 64,
    scopes_FunctionLevelScope = 65,
    scopes_ScopeOfId = 66
}
#[derive(Copy,Clone,Debug,PartialEq,Eq,Hash)]
pub enum Indexes {
...
pub fn prog(__update_cb: Box<dyn CBFn>) -> Program {
    ...
    let __Prefix_0 = Relation {
                         ...
                         rules:        vec![
                             /* __Prefix_0[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span), (name: internment::Intern<string>), (declared: ast::AnyId), (decl: ast::StmtId))] :- __Prefix_1[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span), (name: internment::Intern<string>))], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdStmt{.stmt=(decl: ast::StmtId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)]. */
                             Rule::ArrangementRule {
                                 description: "__Prefix_0[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span), (name: internment::Intern<string>), (declared: ast::AnyId), (decl: ast::StmtId))] :- __Prefix_1[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span), (name: internment::Intern<string>))], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdStmt{.stmt=(decl: ast::StmtId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)].".to_string(),
    ...
    let outputs_use_before_def_UseBeforeDef = Relation {
                                                  ...
                                                  rules:        vec![
                                                      ...
                                                      /* outputs::use_before_def::UseBeforeDef[(outputs::use_before_def::UseBeforeDef{.name=name, .used=expr, .used_in=used_in, .declared=declared, .declared_in=declared_in, .file=file}: outputs::use_before_def::UseBeforeDef)] :- __Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], inputs::Class[(inputs::Class{.id=(class: ast::ClassId), .file=(file: ast::FileId), .name=(ddlog_std::Some{.x=(ast::Spanned{.data=(_: internment::Intern<string>), .span=(declared_in: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<ast::Name>>), .parent=(_: ddlog_std::Option<ast::ExprId>), .elements=(_: ddlog_std::Option<ddlog_std::Vec<ast::IClassElement>>), .scope=(decl_scope: ast::ScopeId), .exported=(_: bool)}: inputs::Class)], (decl_scope != used_scope), not scopes::ChildScope[(scopes::ChildScope{.parent=(decl_scope: ast::ScopeId), .child=(used_scope: ast::ScopeId), .file=(file: ast::FileId)}: scopes::ChildScope)]. */
                                                      Rule::ArrangementRule {
                                                          description: "outputs::use_before_def::UseBeforeDef[(outputs::use_before_def::UseBeforeDef{.name=name, .used=expr, .used_in=used_in, .declared=declared, .declared_in=declared_in, .file=file}: outputs::use_before_def::UseBeforeDef)] :- __Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], inputs::Class[(inputs::Class{.id=(class: ast::ClassId), .file=(file: ast::FileId), .name=(ddlog_std::Some{.x=(ast::Spanned{.data=(_: internment::Intern<string>), .span=(declared_in: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<ast::Name>>), .parent=(_: ddlog_std::Option<ast::ExprId>), .elements=(_: ddlog_std::Option<ddlog_std::Vec<ast::IClassElement>>), .scope=(decl_scope: ast::ScopeId), .exported=(_: bool)}: inputs::Class)], (decl_scope != used_scope), not scopes::ChildScope[(scopes::ChildScope{.parent=(decl_scope: ast::ScopeId), .child=(used_scope: ast::ScopeId), .file=(file: ast::FileId)}: scopes::ChildScope)].".to_string(),
                                                          ...
                                                          xform: XFormArrangement::Join{
                                                                     ...
                                                                     next: Box::new(Some(XFormCollection::Arrange {
                                                                                             ...
                                                                                             __f},
                                                                                             next: Box::new(XFormArrangement::Join{
                                                                                                                description: "__Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)]".to_string(),
                                                                                                                ffun: None,
                                                                                                                ...
                                                                                                                __f},
                                                                                                                next: Box::new(Some(XFormCollection::Arrange {
                                                                                                                                        description: "arrange __Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)] by (class, file)" .to_string(),
                                                                                                                                        afun: &{fn __f(__v: DDValue) -> Option<(DDValue,DDValue)>
                                                                                                                                        {
                                                                                                                                        ...
                                                                                                                                        __f},
                                                                                                                                        next: Box::new(XFormArrangement::Join{
                                                                                                                                                           description: "__Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], inputs::Class[(inputs::Class{.id=(class: ast::ClassId), .file=(file: ast::FileId), .name=(ddlog_std::Some{.x=(ast::Spanned{.data=(_: internment::Intern<string>), .span=(declared_in: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<ast::Name>>), .parent=(_: ddlog_std::Option<ast::ExprId>), .elements=(_: ddlog_std::Option<ddlog_std::Vec<ast::IClassElement>>), .scope=(decl_scope: ast::ScopeId), .exported=(_: bool)}: inputs::Class)]".to_string(),
                                                                                                                                                           ffun: None,
                                                                                                                                                           ...
                                                                                                                                                           __f},
                                                                                                                                                           next: Box::new(Some(XFormCollection::Arrange {
                                                                                                                                                                                   description: "arrange __Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], inputs::Class[(inputs::Class{.id=(class: ast::ClassId), .file=(file: ast::FileId), .name=(ddlog_std::Some{.x=(ast::Spanned{.data=(_: internment::Intern<string>), .span=(declared_in: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<ast::Name>>), .parent=(_: ddlog_std::Option<ast::ExprId>), .elements=(_: ddlog_std::Option<ddlog_std::Vec<ast::IClassElement>>), .scope=(decl_scope: ast::ScopeId), .exported=(_: bool)}: inputs::Class)], (decl_scope != used_scope) by (decl_scope, used_scope, file)" .to_string(),
                                                                                                                                                                                   afun: &{fn __f(__v: DDValue) -> Option<(DDValue,DDValue)>
                                                                                                                                                                                   {
                                                                                                                                                                                   ...
                                                                                                                                                                                   next: Box::new(XFormArrangement::Antijoin {
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      arrangement: (Relations::scopes_ChildScope as RelId,1),
                                                                                                                                                                                                      next: Box::new(Some(XFormCollection::FilterMap{
                                                                                                                                                                                                                              description: "head of outputs::use_before_def::UseBeforeDef[(outputs::use_before_def::UseBeforeDef{.name=name, .used=expr, .used_in=used_in, .declared=declared, .declared_in=declared_in, .file=file}: outputs::use_before_def::UseBeforeDef)] :- __Prefix_2[((expr: ast::ExprId), (file: ast::FileId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))], inputs::NameRef[(inputs::NameRef{.expr_id=(callee: ast::ExprId), .file=(file: ast::FileId), .value=(name: internment::Intern<string>)}: inputs::NameRef)], name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(used_scope: ast::ScopeId), .span=(_: ddlog_std::Option<ast::Span>), .declared_in=(declared@ (ast::AnyIdClass{.class=(class: ast::ClassId)}: ast::AnyId)), .implicit=(_: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], inputs::Class[(inputs::Class{.id=(class: ast::ClassId), .file=(file: ast::FileId), .name=(ddlog_std::Some{.x=(ast::Spanned{.data=(_: internment::Intern<string>), .span=(declared_in: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<ast::Name>>), .parent=(_: ddlog_std::Option<ast::ExprId>), .elements=(_: ddlog_std::Option<ddlog_std::Vec<ast::IClassElement>>), .scope=(decl_scope: ast::ScopeId), .exported=(_: bool)}: inputs::Class)], (decl_scope != used_scope), not scopes::ChildScope[(scopes::ChildScope{.parent=(decl_scope: ast::ScopeId), .child=(used_scope: ast::ScopeId), .file=(file: ast::FileId)}: scopes::ChildScope)]." .to_string(),
                                                                                                                                                                                                                              fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                                                                                                                                                                                                              {
    ...
    let outputs_no_shadow_NoShadow = Relation {
                                         ...
                                         rules:        vec![
                                             /* outputs::no_shadow::NoShadow[(outputs::no_shadow::NoShadow{.variable=original_name, .original=(original_id, original_span), .shadow=(shadow_id, shadow_span), .implicit=original_implicit, .file=file}: outputs::no_shadow::NoShadow)] :- name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})))), (((var shadow_name: internment::Intern<string>), (var shadow_span: ast::Span), (var shadow_id: ast::AnyId), (var shadow_implicit: bool)) = shadow), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(shadow_id: ast::AnyId), .file=(file: ast::FileId), .scope=(shadow_scope: ast::ScopeId)}: scopes::ScopeOfId)], scopes::ChildScope[(scopes::ChildScope{.parent=(original_scope: ast::ScopeId), .child=(shadow_scope: ast::ScopeId), .file=(file: ast::FileId)}: scopes::ChildScope)]. */
                                             Rule::ArrangementRule {
                                                 description: "outputs::no_shadow::NoShadow[(outputs::no_shadow::NoShadow{.variable=original_name, .original=(original_id, original_span), .shadow=(shadow_id, shadow_span), .implicit=original_implicit, .file=file}: outputs::no_shadow::NoShadow)] :- name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})))), (((var shadow_name: internment::Intern<string>), (var shadow_span: ast::Span), (var shadow_id: ast::AnyId), (var shadow_implicit: bool)) = shadow), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(shadow_id: ast::AnyId), .file=(file: ast::FileId), .scope=(shadow_scope: ast::ScopeId)}: scopes::ScopeOfId)], scopes::ChildScope[(scopes::ChildScope{.parent=(original_scope: ast::ScopeId), .child=(shadow_scope: ast::ScopeId), .file=(file: ast::FileId)}: scopes::ChildScope)].".to_string(),
                                                 ...
                                                 xform: XFormArrangement::Aggregate{
                                                            ...
                                                            aggfun: &{fn __f(__key: &DDValue, __group__: &[(&DDValue, Weight)]) -> Option<DDValue>
                                                        {
                                                            ...
                                                            Some((::types::ddlog_std::tuple2((*file).clone(), (*vars).clone())).into_ddvalue())
                                                        }
                                                        __f},
                                                            next: Box::new(Some(XFormCollection::FlatMap{
                                                                                    ...
                                                                                    fmfun: &{fn __f(__v: DDValue) -> Option<Box<dyn Iterator<Item=DDValue>>>
                                                                                    {
                                                                                        let ::types::ddlog_std::tuple2(ref file, ref vars) = *unsafe {<::types::ddlog_std::tuple2<::types::ast::FileId, ::types::ddlog_std::Group<::types::ddlog_std::tuple2<::types::ast::FileId, ::types::ast::ScopeId>, ::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>>>::from_ddvalue_ref( &__v ) };
                                                                                        ...
                                                                                        let file = (*file).clone();
                                                                                        let vars = (*vars).clone();
                                                                                        Some(Box::new(__flattened.into_iter().map(move |original|(::types::ddlog_std::tuple3(original.clone(), file.clone(), vars.clone())).into_ddvalue())))
                                                                                    }
                                                                                    __f},
                                                                                    next: Box::new(Some(XFormCollection::Arrange {
                                                                                                            ...
                                                                                                            afun: &{fn __f(__v: DDValue) -> Option<(DDValue,DDValue)>
                                                                                                            {
                                                                                                                let ::types::ddlog_std::tuple3(ref original, ref file, ref vars) = *unsafe {<::types::ddlog_std::tuple3<::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>, ::types::ast::FileId, ::types::ddlog_std::Group<::types::ddlog_std::tuple2<::types::ast::FileId, ::types::ast::ScopeId>, ::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>>>::from_ddvalue_ref( &__v ) };
                                                                                                                ...
                                                                                                                Some(((::types::ddlog_std::tuple2((*original_id).clone(), (*file).clone())).into_ddvalue(), (::types::ddlog_std::tuple7((*original).clone(), (*file).clone(), (*vars).clone(), (*original_name).clone(), (*original_span).clone(), (*original_id).clone(), (*original_implicit).clone())).into_ddvalue()))
                                                                                                            }
                                                                                                            __f},
                                                                                                            next: Box::new(XFormArrangement::Join{
                                                                                                                               ...
                                                                                                                               jfun: &{fn __f(_: &DDValue ,__v1: &DDValue,__v2: &DDValue) -> Option<DDValue>
                                                                                                                               {
                                                                                                                                   let ::types::ddlog_std::tuple7(ref original, ref file, ref vars, ref original_name, ref original_span, ref original_id, ref original_implicit) = *unsafe {<::types::ddlog_std::tuple7<::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>, ::types::ast::FileId, ::types::ddlog_std::Group<::types::ddlog_std::tuple2<::types::ast::FileId, ::types::ast::ScopeId>, ::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>, ::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>::from_ddvalue_ref( __v1 ) };
                                                                                                                                   ...
                                                                                                                                   Some((::types::ddlog_std::tuple8((*original).clone(), (*file).clone(), (*vars).clone(), (*original_name).clone(), (*original_span).clone(), (*original_id).clone(), (*original_implicit).clone(), (*original_scope).clone())).into_ddvalue())
                                                                                                                               }
                                                                                                                               __f},
                                                                                                                               next: Box::new(Some(XFormCollection::FlatMap{
                                                                                                                                                       description: "name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))}))))" .to_string(),
                                                                                                                                                       fmfun: &{fn __f(__v: DDValue) -> Option<Box<dyn Iterator<Item=DDValue>>>
                                                                                                                                                       {
                                                                                                                                                           let ::types::ddlog_std::tuple8(ref original, ref file, ref vars, ref original_name, ref original_span, ref original_id, ref original_implicit, ref original_scope) = *unsafe {<::types::ddlog_std::tuple8<::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>, ::types::ast::FileId, ::types::ddlog_std::Group<::types::ddlog_std::tuple2<::types::ast::FileId, ::types::ast::ScopeId>, ::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>, ::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool, ::types::ast::ScopeId>>::from_ddvalue_ref( &__v ) };
                                                                                                                                                           let __flattened = ::types::vec::filter::<::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>((&::types::ddlog_std::to_vec_ddlog_std_Group__K_V_ddlog_std_Vec__V::<::types::ddlog_std::tuple2<::types::ast::FileId, ::types::ast::ScopeId>, ::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>>(vars)), (&{
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                (Box::new(closure::ClosureImpl{
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    description: "(function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    f: {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           fn __f(__args:*const ::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>, __captured: &(::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>, ::types::internment::Intern<String>, ::types::ast::Span)) -> bool
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               let shadow = unsafe{&*__args};
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               (((((&*shadow) != (&*original)) && ((&*(&(shadow.0))) == (&*original_name))) && ((&*original_span) != (&*(&(shadow.1))))) && (!(shadow.3).clone()))
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           __f
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       }
                                                                                                                                                           ...
                                                                                                                                                           Some(Box::new(__flattened.into_iter().map(move |shadow|(::types::ddlog_std::tuple7(shadow.clone(), file.clone(), original_name.clone(), original_span.clone(), original_id.clone(), original_implicit.clone(), original_scope.clone())).into_ddvalue())))
                                                                                                                                                       }
                                                                                                                                                       __f},
                                                                                                                                                       next: Box::new(Some(XFormCollection::Arrange {
                                                                                                                                                                               description: "arrange name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})))) by (shadow_id, file)" .to_string(),
                                                                                                                                                                               afun: &{fn __f(__v: DDValue) -> Option<(DDValue,DDValue)>
                                                                                                                                                                               {
                                                                                                                                                                                   let ::types::ddlog_std::tuple7(ref shadow, ref file, ref original_name, ref original_span, ref original_id, ref original_implicit, ref original_scope) = *unsafe {<::types::ddlog_std::tuple7<::types::ddlog_std::tuple4<::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool>, ::types::ast::FileId, ::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool, ::types::ast::ScopeId>>::from_ddvalue_ref( &__v ) };
                                                                                                                                                                                   let (ref shadow_name, ref shadow_span, ref shadow_id, ref shadow_implicit): (::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool) = match (*shadow).clone() {
                                                                                                                                                                                       ::types::ddlog_std::tuple4(shadow_name, shadow_span, shadow_id, shadow_implicit) => (shadow_name, shadow_span, shadow_id, shadow_implicit),
                                                                                                                                                                                       _ => return None
                                                                                                                                                                                   };
                                                                                                                                                                                   Some(((::types::ddlog_std::tuple2((*shadow_id).clone(), (*file).clone())).into_ddvalue(), (::types::ddlog_std::tuple8((*file).clone(), (*original_name).clone(), (*original_span).clone(), (*original_id).clone(), (*original_implicit).clone(), (*original_scope).clone(), (*shadow_span).clone(), (*shadow_id).clone())).into_ddvalue()))
                                                                                                                                                                               }
                                                                                                                                                                               __f},
                                                                                                                                                                               next: Box::new(XFormArrangement::Join{
                                                                                                                                                                                                  description: "name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})))), (((var shadow_name: internment::Intern<string>), (var shadow_span: ast::Span), (var shadow_id: ast::AnyId), (var shadow_implicit: bool)) = shadow), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(shadow_id: ast::AnyId), .file=(file: ast::FileId), .scope=(shadow_scope: ast::ScopeId)}: scopes::ScopeOfId)]".to_string(),
                                                                                                                                                                                                  ffun: None,
                                                                                                                                                                                                  arrangement: (Relations::scopes_ScopeOfId as RelId,0),
                                                                                                                                                                                                  jfun: &{fn __f(_: &DDValue ,__v1: &DDValue,__v2: &DDValue) -> Option<DDValue>
                                                                                                                                                                                                  {
                                                                                                                                                                                                      let ::types::ddlog_std::tuple8(ref file, ref original_name, ref original_span, ref original_id, ref original_implicit, ref original_scope, ref shadow_span, ref shadow_id) = *unsafe {<::types::ddlog_std::tuple8<::types::ast::FileId, ::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool, ::types::ast::ScopeId, ::types::ast::Span, ::types::ast::AnyId>>::from_ddvalue_ref( __v1 ) };
                                                                                                                                                                                                      let ref shadow_scope = match *unsafe {<::types::scopes::ScopeOfId>::from_ddvalue_ref(__v2) } {
                                                                                                                                                                                                          ::types::scopes::ScopeOfId{id: _, file: _, scope: ref shadow_scope} => (*shadow_scope).clone(),
                                                                                                                                                                                                          _ => return None
                                                                                                                                                                                                      };
                                                                                                                                                                                                      Some((::types::ddlog_std::tuple9((*file).clone(), (*original_name).clone(), (*original_span).clone(), (*original_id).clone(), (*original_implicit).clone(), (*original_scope).clone(), (*shadow_span).clone(), (*shadow_id).clone(), (*shadow_scope).clone())).into_ddvalue())
                                                                                                                                                                                                  }
                                                                                                                                                                                                  __f},
                                                                                                                                                                                                  next: Box::new(Some(XFormCollection::Arrange {
                                                                                                                                                                                                                          description: "arrange name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})))), (((var shadow_name: internment::Intern<string>), (var shadow_span: ast::Span), (var shadow_id: ast::AnyId), (var shadow_implicit: bool)) = shadow), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(shadow_id: ast::AnyId), .file=(file: ast::FileId), .scope=(shadow_scope: ast::ScopeId)}: scopes::ScopeOfId)] by (original_scope, shadow_scope, file)" .to_string(),
                                                                                                                                                                                                                          afun: &{fn __f(__v: DDValue) -> Option<(DDValue,DDValue)>
                                                                                                                                                                                                                          {
                                                                                                                                                                                                                              let ::types::ddlog_std::tuple9(ref file, ref original_name, ref original_span, ref original_id, ref original_implicit, ref original_scope, ref shadow_span, ref shadow_id, ref shadow_scope) = *unsafe {<::types::ddlog_std::tuple9<::types::ast::FileId, ::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool, ::types::ast::ScopeId, ::types::ast::Span, ::types::ast::AnyId, ::types::ast::ScopeId>>::from_ddvalue_ref( &__v ) };
                                                                                                                                                                                                                              Some(((::types::ddlog_std::tuple3((*original_scope).clone(), (*shadow_scope).clone(), (*file).clone())).into_ddvalue(), (::types::ddlog_std::tuple7((*file).clone(), (*original_name).clone(), (*original_span).clone(), (*original_id).clone(), (*original_implicit).clone(), (*shadow_span).clone(), (*shadow_id).clone())).into_ddvalue()))
                                                                                                                                                                                                                          }
                                                                                                                                                                                                                          __f},
                                                                                                                                                                                                                          next: Box::new(XFormArrangement::Semijoin{
                                                                                                                                                                                                                                             description: "name_in_scope::NameInScope[(name_in_scope::NameInScope{.file=(file: ast::FileId), .name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId), .span=(ddlog_std::Some{.x=(span: ast::Span)}: ddlog_std::Option<ast::Span>), .declared_in=(declared: ast::AnyId), .implicit=(is_implicit: bool), .is_arg=(_: bool)}: name_in_scope::NameInScope)], var __group = (name, span, declared, is_implicit).group_by((file, scope)), ((var vars: ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>) = __group), var original = FlatMap(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars))), (((var original_name: internment::Intern<string>), (var original_span: ast::Span), (var original_id: ast::AnyId), (var original_implicit: bool)) = original), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(original_id: ast::AnyId), .file=(file: ast::FileId), .scope=(original_scope: ast::ScopeId)}: scopes::ScopeOfId)], var shadow = FlatMap(((vec::filter: function(ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>, function((internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(((ddlog_std::to_vec: function(ddlog_std::Group<(ast::FileId, ast::ScopeId),(internment::Intern<string>, ast::Span, ast::AnyId, bool)>):ddlog_std::Vec<(internment::Intern<string>, ast::Span, ast::AnyId, bool)>)(vars)), (function(shadow: (internment::Intern<string>, ast::Span, ast::AnyId, bool)):bool{((((shadow != original) and ((shadow.0) == original_name)) and (original_span != (shadow.1))) and (not (shadow.3)))})))), (((var shadow_name: internment::Intern<string>), (var shadow_span: ast::Span), (var shadow_id: ast::AnyId), (var shadow_implicit: bool)) = shadow), scopes::ScopeOfId[(scopes::ScopeOfId{.id=(shadow_id: ast::AnyId), .file=(file: ast::FileId), .scope=(shadow_scope: ast::ScopeId)}: scopes::ScopeOfId)], scopes::ChildScope[(scopes::ChildScope{.parent=(original_scope: ast::ScopeId), .child=(shadow_scope: ast::ScopeId), .file=(file: ast::FileId)}: scopes::ChildScope)]".to_string(),
                                                                                                                                                                                                                                             ...
                                                                                                                                                                                                                                             jfun: &{fn __f(_: &DDValue ,__v1: &DDValue,___v2: &()) -> Option<DDValue>
                                                                                                                                                                                                                                             {
                                                                                                                                                                                                                                                 let ::types::ddlog_std::tuple7(ref file, ref original_name, ref original_span, ref original_id, ref original_implicit, ref shadow_span, ref shadow_id) = *unsafe {<::types::ddlog_std::tuple7<::types::ast::FileId, ::types::internment::Intern<String>, ::types::ast::Span, ::types::ast::AnyId, bool, ::types::ast::Span, ::types::ast::AnyId>>::from_ddvalue_ref( __v1 ) };
                                                                                                                                                                                                                                                 Some(((::types::outputs::no_shadow::NoShadow{variable: (*original_name).clone(), original: ::types::ddlog_std::tuple2((*original_id).clone(), (*original_span).clone()), shadow: ::types::ddlog_std::tuple2((*shadow_id).clone(), (*shadow_span).clone()), implicit: (*original_implicit).clone(), file: (*file).clone()})).into_ddvalue())
                                                                                                                                                                                                                                             }
                                                                                                                                                                                                                                             __f},
                                                                                                                                                                                                                                             next: Box::new(None)
                                                                                                                                                                                                                                         })
